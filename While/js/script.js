...
// lê um numero e faz sua tabuada até o decimo numero

document.getElementById("roll").innerHTML = " ";

function tabuadaQualquer() {
  document.getElementById("roll").innerHTML = "";
...
function segundo() {
  ...
  document.getElementById("titulo-exercicio").innerHTML = "L03B - Soma dos 100";
  document.getElementById("texto-exercicio").innerHTML =
    "Exibe a soma dos 100 primeiros números.";

  document.getElementById("button").setAttribute("onclick", "cemPrimeiros()");
}
...
function cemPrimeiros() {
  ...
  while (contadora <= 100) {
    const node = document.createTextNode(`${acumuladora} + ${contadora} = `);
...
function terceiro() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "L03C - Soma dos 500 pares";
  document.getElementById("texto-exercicio").innerHTML =
    "Apresenta a soma dos 500 primeiros números pares.";

  document.getElementById("button").setAttribute("onclick", "quinhentos()");
}
...
// Apresentar todos os valores numéricos inteiros ímpares situados na faixa de 0 a 20. Para verificar se o número é ímpar, efetuar dentro da malha a
// verificação lógica desta condição com a instrução se, perguntando se o número é ímpar; sendo, mostre-o; não sendo, passe para o próximo passo.
...
function quarto() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "L03D - Ímpares até 20";
  document.getElementById("texto-exercicio").innerHTML =
    "Apresenta todos os números inteiros ímpares de 0 a 20.";

  document.getElementById("button").setAttribute("onclick", "vinteImpares()");
}

function vinteImpares() {
  document.getElementById("roll").innerHTML = "";
  ...
  while (contadora <= 20) {
    if (contadora % 2 == 1) {
      const parag = document.createElement("p");
      const node = document.createTextNode(`${contadora}`);
...
// Apresentar os resultados das potências de 3, variando do expoente 0 até o expoente 15. Deve ser considerado  que  qualquer  número  elevado  a  zero  é  1,
//  e  elevado  a  1  é  ele  próprio.  Observe  que neste exercício não pode ser utilizado o operador de exponenciação do portuguol (^).
...
function quinto() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "l03E - Potências de 3";
  document.getElementById("texto-exercicio").innerHTML =
    "Exibe o resultado das protências de 3 até a 15 potência.";

  document.getElementById("button").setAttribute("onclick", "potenciasTres()");
}

function potenciasTres() {
  document.getElementById("roll").innerHTML = "";
  ...
  while (contadora <= 15) {
    const parag = document.createElement("p");
    const node = document.createTextNode(
      `3 elevado à ${contadora}° potência é: ${exponenciação}`
    );
...
function sexto() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "L03F - Expoente e base quaisquer";
  document.getElementById("texto-exercicio").innerHTML =
    "Exibe o resultado de uma exponenciação de base e expoente quaisquer.";

  document
    .getElementById("button")
    .setAttribute("onclick", "exponenteQualquer()");
}

function exponenteQualquer() {
  document.getElementById("roll").innerHTML = "";
  ...
  while (contadora <= expoente) {
    const parag = document.createElement("p");
    const node = document.createTextNode(
      `${base} elevado a ${contadora}° potência é: ${exponenciação}`
    );
...
// Escreva  um  programa  que  apresente  a  série  de  Fibonacci  até  o  décimo  quinto  termo.  A  série  de Fibonacci  é
// formada  pela  seqüência:  1,  1,  2,  3,  5, 8,  13,  21,  34,  ...,  etc.  Esta  série  se  caracteriza pela  soma  de  um
// termo  atual  com  o  seu  anterior  subseqüente,  para  que  seja  formado  o
...
function setimo() {
  ...
  document.getElementById("titulo-exercicio").innerHTML = "L03G - Fibonacci";
  document.getElementById("texto-exercicio").innerHTML =
    "Apresenta  a  série  de  Fibonacci  até  o  décimo  quinto  termo.";

  document.getElementById("button").setAttribute("onclick", "fibonacci()");
}
...
function fibonacci() {
  ...
  while (contadora <= 15) {
    ...
    const parag = document.createElement("p");
    const node = document.createTextNode(`${a} + ${b} = ${fibonacci}`);
...
function oitavo() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 19 - Maior Valor";
  document.getElementById("texto-exercicio").innerHTML =
    "Lê 2 valores e exibe o maior.";
...
function decimo() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 21 - Duração do Xadrez";
  document.getElementById("texto-exercicio").innerHTML =
    "Lê a hora de início e de finalização de uma partida de xadrez (sem minutos), e calcula sua duração em horas, sabendo que uma partida tem duração máxima de 24 horas e que o jogo pode iniciar em um dia e terminar no dia seguinte. ";
...
function xadrez() {
  let inicio = parseInt(
    prompt("Digite o horário de início do jogo de xadrez (sem os minutos):")
  );
  let termino = parseInt(
    prompt("Digite o horário de término do jogo de xadrez (sem os minutos):")
  );

  let duracao = termino - inicio;

  if (duracao == 0) {
    // Se a subtracao der 0, significa que se passaram 24 horas de partida
...
function onze() {
  ...
  document.getElementById("texto-exercicio").innerHTML =
    "Lê a quantidade de horas extras trabalhadas em um mês e o salário por hora e exibe o slátio final.";
...
function horasExtras() {
  ...
  let horasTrabalhadas = parseInt(
    prompt(`Digite o a quantidade de horas trabalhadas por ${nome}:`)
  );
  ...
  if (horasExtras > 0) {
    ...
    let salarioFinal =
      salario * (horasTrabalhadas - horasExtras) + salarioExtra;
...
function doze() {
  ...
  document.getElementById("texto-exercicio").innerHTML =
    "Lê o sexo e a altura de uma pessoa e exibe seu peso ideal.";
...
function pesoIdeal() {
  ...
  if (sexo == "M" || sexo == "m") {
    ...
    document.getElementById(
      "resultado"
    ).innerHTML = ` Seu peso ideal é: ${pesoIdeal}Kg.`;
  } else {
...
function treze() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 24 - Venda e Comissão";
  document.getElementById("texto-exercicio").innerHTML =
    "Lê o salário fixo e o valor das vendas e exibe o salario final, 3% sobre o total das vendas até R$1.500,00 mais 5% sobre o que ultrapassar este valor";
...
function quatorze() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 25 - Saldo Bancário";
  document.getElementById("texto-exercicio").innerHTML =
    "Lê número da conta, saldo, débito e crédito e exibe o saldo final";
...
function quinze() {
  ...
  document.getElementById("texto-exercicio").innerHTML =
    "Lê a quantidade atual de estoque, quantidade minima e maxima, calcula e exibe a quantidade média e se há a necessidade de compra";
...
function estoque() {
  ...
  if (qtdAtual >= media) {
    document.getElementById(
      "resultado"
    ).innerHTML = ` Quantidade atual: ${qtdAtual}
...
function dezesseis() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 27 - Conferir Numero";
  document.getElementById("texto-exercicio").innerHTML =
    "lê um númeor e verifica se ele é maior menor ou igual a zero e o exibe";
...
function conferir() {
  ...
  if (numero > 0) {
    document.getElementById(
      "resultado"
    ).innerHTML = ` ${numero} é maior que zero.`;
  } else if (numero < 0) {
    document.getElementById(
      "resultado"
    ).innerHTML = ` ${numero} é menor que zero.`;
  } else {
    document.getElementById(
      "resultado"
    ).innerHTML = ` ${numero} é igual a zero.`;
  }
}
...
function dezessete() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 28 - Conferir Maior Número";
  document.getElementById("texto-exercicio").innerHTML =
    "lê um número e verifica se ele é maior menor ou igual a zero e o exibe";
...
function dezessete() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 28 - Conferir Numero";
  document.getElementById("texto-exercicio").innerHTML =
    "lê 3 números, e escreve o maior entre eles";
...
function maiorEntreTres() {
  ...
  if (numero1 > numero2 && numero1 > numero3) {
    document.getElementById(
      "resultado"
    ).innerHTML = ` O primeiro número "${numero1}" é o maior número.`;
  } else if (numero2 > numero1 && numero2 > numero3) {
    document.getElementById(
      "resultado"
    ).innerHTML = ` O segundo número "${numero2}" é o maior número.`;
  } else if (numero3 > numero1 && numero3 > numero2) {
    document.getElementById(
      "resultado"
    ).innerHTML = ` O terceiro número "${numero3}" é o maior número.`;
  }
}
...
function dezoito() {
  ...
  document.getElementById("texto-exercicio").innerHTML =
    "lê 3 números, soma os dois maiores e exibe o resultado";

  document
    .getElementById("button")
    .setAttribute("onclick", "somaDoisMaiores()");
}
...
function dezenove() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 30 - Ordem Crescente";
  document.getElementById("texto-exercicio").innerHTML =
    "lê 3 números, e os coloca em ordem crescente";

  document
    .getElementById("button")
    .setAttribute("onclick", "ordemCrescente3()");
}
...
function vinte() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 31 - Triângulo ou Não?";
  document.getElementById("texto-exercicio").innerHTML =
    "lê 3 números representando as medidas dos lados de um triângulo e escrever se formam ou não um triângulo";
...
function vinteum() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 32 - Time Vencedor";
  document.getElementById("texto-exercicio").innerHTML =
    "lê 2 nomes de times e a quantidade de gols de cada e exibe o time vencedor ou empate.";
...
function timeVencedor() {
  ...
  if (golsa > golsb) {
    document.getElementById(
      "resultado"
    ).innerHTML = `Placar: ${golsa} X ${golsb}
                                                            \nVencedor: ${timea}
                                                            \nCom ${
                                                              golsa - golsb
                                                            } de vantagem.`;
    ...
    document.getElementById(
      "resultado"
    ).innerHTML = `Placar: ${golsb} X ${golsa}
                                                            \nVencedor: ${timeb}
                                                            \nCom ${
                                                              golsb - golsa
                                                            } de vantagem.`;
...
function vintedois() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 33 - Igual ou Maior?";
  document.getElementById("texto-exercicio").innerHTML =
    "lê 2 valores e exibe se são iguais ou se o primeiro ou segundo é maior.";

  document
    .getElementById("button")
    .setAttribute("onclick", "confiraIgualMaior()");
}
...
function vintetres() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 34 - Teste de Mesa";
  document.getElementById("texto-exercicio").innerHTML =
    "Lê 2 valores e realiza um 'teste de mesa' em um algoritmo";
...
function vintequatro() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 35 - Preço Gasolina";
  document.getElementById("texto-exercicio").innerHTML =
    "Lê a quantidade em litros de combustivel, verifica se é alcool ou gasolina e calcula o valor final com desconto";
...
function combustivel() {
  let litros = parseInt(
    prompt(`Digite a quantidade de combustível vendida, em litros:`)
  );
  let tipoCombustivel = prompt(
    `Digite o tipo de combustível vendido:  'G' - Gasolina e 'A' - Álcool`
  );
  ...
  if (tipoCombustivel == "G" || tipoCombustivel == "g") {
    if (litros <= 20) {
      ...
      document.getElementById(
        "resultado"
      ).innerHTML = `O valor pago pelo cliente devará ser de: R$ ${preco.toFixed(
        2
      )}`;
    } else {
    ...
    document.getElementById(
      "resultado"
    ).innerHTML = `Digite um combustível válido.`;
  }
}
...
function vintecinco() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 36 - Diferença de idades";
  document.getElementById("texto-exercicio").innerHTML =
    "le 4 idade, 2 de homens e 2 de mulheres, compara e soma a do homem mais velho com a mulher mais nova e multiplica a da mulher mais velha com o homem mais novo";
...
function diferencaIdade() {
  ...
  if (idadeh > 0 && idadem > 0) {
    ...
    document.getElementById(
      "resultado"
    ).innerHTML = `A soma da idade do homem mais velho com a mulher mais nova é: ${soma}`;
    document.getElementById(
      "resultado"
    ).innerHTML = `A multiplicação da idade da mulher mais velha com o homm mais novo é: ${mult}`;
...
function vinteseis() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 37 - Fruteira";
  document.getElementById("texto-exercicio").innerHTML =
    "lê a quatidade de frutas compradas, e calcula o preco com desconto";
...
function fruteira() {
  ...
  if (macakg > 5) {
    precomaca = 1.5 * macakg;
  } else {
    precomaca = 1.8 * macakg;
  }
  ...
  let precomorango = 0;
  if (morangokg > 5) {
    precomorango = 2.2 * morangokg;
  } else {
    precomorango = 2.5 * morangokg;
  }
  ...
  if (totalkg > 8 || totalpreco > 25) {
    let precoFn = totalpreco - totalpreco * 0.1;
    document.getElementById(
      "resultado"
    ).innerHTML = ` O preço das maças ficou: R$: ${precomaca.toFixed(2)}
                                                            \nO preço dos morangos ficou: R$: ${precomorango.toFixed(
                                                              2
                                                            )}
                                                            \nPeso total: ${totalkg}Kg
                                                            \nO preço total sem desconto ficou: R$ ${totalpreco.toFixed(
                                                              2
                                                            )}
                                                            \n
                                                            \nPreço final com desconto: R$ ${precoFn.toFixed(
                                                              2
                                                            )}`;
  } else {
    document.getElementById(
      "resultado"
                                                            ...
                                                            \nPeso total: ${totalkg}Kg
                                                            \nO preço final ficou: R$ ${totalpreco.toFixed(
                                                              2
                                                            )}`;
  }
}
...
function vintesete() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 38 - Acesso com Senha";
  document.getElementById("texto-exercicio").innerHTML =
    "Pede o usuario e a senha e permite ou nega o acesso se os dados estiverem corretos ou nao <br> (Dica: Usuário: 1234 & Senha: 9999)";
...
function acessoComSenha() {
  ...
  let usuario = parseInt(
    prompt(`Digite seu código de usuário: (somente números) `)
  );
...
function vinteoito() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 40 - Desconto com Quantidade";
  document.getElementById("texto-exercicio").innerHTML =
    "Pede nome, quantidade e preço unitario, calcula desconto e mostra o preço total com desconto";

  document
    .getElementById("button")
    .setAttribute("onclick", "DescontoComQuantidade()");
}

function DescontoComQuantidade() {
  let nome = prompt(`Digiteo nome do produto `);
  let quantidade = parseInt(prompt(`Digite a quantidade: `));
  let precoUnidade = parseInt(
    prompt(`Digite o preço por unidade do produto: `)
  );
  ...
  if (quantidade > 10) {
    ...
    document.getElementById(
      "resultado"
    ).innerHTML = ` Preço total sem desconto: R$ ${total.toFixed(2)}
                                                            \nDesconto de: R$ ${desconto.toFixed(
                                                              2
                                                            )}
                                                            \nPreço final com 5% de desconto: R$ ${totalDesconto.toFixed(
                                                              2
                                                            )}`;
    ...
    document.getElementById(
      "resultado"
                                                            ...
                                                            \nPreço final com 3% de desconto: R$ ${totalDesconto.toFixed(
                                                              2
                                                            )}`;
    ...
    document.getElementById(
      "resultado"
                                                            ...
                                                            \nPreço final com 2% de desconto: R$ ${totalDesconto.toFixed(
                                                              2
                                                            )}`;
  }
}
...
function vintenove() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 41 - Média de aproveitamento";
  document.getElementById("texto-exercicio").innerHTML =
    "Pede as notas do aluno e a média obtida dos exercícios, calcula e exibe a média de aproveitamento e exibe seu conceito";

  document
    .getElementById("button")
    .setAttribute("onclick", "mediaDeAproveitamento()");
}
...
function mediaDeAproveitamento() {
  ...
  if (mediaDeAproveitamento >= 9) {
    document.getElementById("resultado").innerHTML = ` Nota 1:  ${n1}
                                                            ...
                                                            \nNota 3: ${n3}
                                                            \nMédia: ${media}
                                                            \nMédia de aproveitamento: ${mediaDeAproveitamento.toFixed(
                                                              2
                                                            )}
                                                            \nConceito final: A`;
...
function trinta() {
  ...
  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 42 - Aposentadoria";
  document.getElementById("texto-exercicio").innerHTML =
    "Verifica as informações de um funcionário e verifica a necessidade de requerer ou não a aposentadoria";
...
function Aposentadoria() {
  ...
  let dataNasc = parseInt(
    prompt(`Digite o ano de nascimento do funcionário: `)
  );
  let anoIngresso = parseInt(
    prompt(`Digite o ano em que o funcionário ingressou na empresa: `)
  );
  let date = new Date();
...
function trintaum() {
  ...
  document
    ...
    .setAttribute("onclick", 'alert("Este é o último exercício.")');

  document.getElementById("titulo-exercicio").innerHTML =
    "Exercicio 43 - Triângulos";
  document.getElementById("texto-exercicio").innerHTML =
    "Lê os três lados do triângulo e exibe se ele é um triângulo equilátero, Isóceles, escaleno ou se não é um triângulo";
...
function QualTriangulo() {
  ...
  if (a < b + c && b < a + c && c < a + b) {
    if (a == b && b == c) {
      document.getElementById(
        "resultado"
      ).innerHTML = `É um triângulo equilátero`;
    } else if (a == b || b == c || a == c) {
      document.getElementById(
        "resultado"
      ).innerHTML = `É um triângulo isóceles`;
    } else {
      document.getElementById(
        "resultado"
      ).innerHTML = `É um triângulo escaleno`;
    }
  } else {
    document.getElementById(
      "resultado"
    ).innerHTML = `Não é possível criar um triângulo`;
  }
}
